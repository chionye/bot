...
class MyOrder(models.Model):
    ...
    client = models.ForeignKey(User, on_delete=models.CASCADE,editable=False) # The user the bot is making the order for
...
class STEP(models.Model):
    ...
    step = models.CharField(max_length=20,)# The current step the use is in
